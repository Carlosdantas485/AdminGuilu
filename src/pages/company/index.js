    ...
    <>
        ...
        <Container>
            <div class="company-list">
                <p class="company-list tittle">Lista de Empresas</p>
				<ul>
					<li>
                        <div class="company-list text">
                            <p >Email</p>
                            <p class='company-name'>Empresa 1</p>
                        </div>
            ...
            <div>
                <div class='modal-delete'>
                    <div>
                        <p class='modal-delete tittle'>Excluir empresa</p>
                        <p class='modal-delete text'>Tem certeza que deseja excluir esta empresa?</p>
                        <button>Sim</button>
                        <button>Não</button>
                    </div>
                </div>
